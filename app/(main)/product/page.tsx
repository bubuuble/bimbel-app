...
// --- [BARU] --- Impor hook yang baru kita buat
import { useMidtransSnap } from "@/lib/hooks/useMidtransSnap";

// ... (Komponen CategoryFilters tidak berubah, biarkan seperti adanya) ...
            ...
            style={{
              ...
              borderColor:
                selectedCategory === category.value
                  ...
                  : "rgb(0,75,173)",
              color:
                selectedCategory === category.value ? "white" : "rgb(0,75,173)",
            }}
          >
            {category.label}
            <Badge
...
export default function ProductPage() {
  ...
  // --- [BARU] --- State untuk proses pembayaran dan memuat script Midtrans
  ...
  const handlePayment = async (product: Product) => {
    if (!snap) {
      alert("Midtrans Snap is not ready yet.");
      return;
    }
    ...
    try {
      // Panggil API backend Anda untuk membuat transaksi
      const response = await fetch("/api/create-transaction", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          productId: product._id, // Ini adalah Sanity Product ID
      ...
      snap.pay(token, {
        onSuccess: function (result: any) {
          ...
          // Di sini Anda bisa redirect ke halaman dashboard atau riwayat pesanan
          window.location.href = "/dashboard/riwayat-pesanan";
        },
  ...
  // ... (Loading state dan return JSX tidak berubah BANYAK, HANYA di bagian <ProductModal>) ...
  if (loading) {
    return (
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(0,75,173,0.05) 0%, rgba(209,51,19,0.05) 100%)",
        }}
      >
        <div className="text-center">
          <Loader2
            ...
            style={{ color: "rgb(0,75,173)" }}
          />
          <p className="text-lg" style={{ color: "rgb(0,75,173)" }}>
            Memuat produk...
          </p>
        </div>
      </section>
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(135deg, rgba(0,75,173,0.03) 0%, rgba(209,51,19,0.03) 100%)",
      }}
    >
      <div className="container mx-auto px-6">
        {/* ... (Header Section, Statistics, Search Bar, CategoryFilters, View Mode Toggle tidak berubah) ... */}
        <div className="text-center mb-12">
          ...
          >
            Temukan paket bimbingan belajar yang paling sesuai untuk mencapai
            target akademik Anda. Pilih dari berbagai kategori program yang
            tersedia.
          </p>
        ...
        <div className="flex justify-center mb-8">
          <div
            className="flex items-center gap-2 p-1 bg-white rounded-lg shadow-md border-2"
          ...
          >
            <Button
              ...
              style={{
                backgroundColor:
                  viewMode === "grid" ? "rgb(0,75,173)" : "transparent",
            ...
            <Button
              ...
              style={{
                backgroundColor:
                  viewMode === "list" ? "rgb(0,75,173)" : "transparent",
        ...
        {filteredProducts.length > 0 ? (
          ...
          <div className="text-center py-16">
            {/* ... (kode untuk produk tidak ditemukan tidak berubah) ... */}
            <div
            ...
            >
              <Search
                className="w-12 h-12"
                style={{ color: "rgb(0,75,173)", opacity: 0.5 }}
              />
            </div>
            <h3
      ...
      {selectedProduct && (
        <ProductModal
          ...
          // --- [BARU] --- Kirim props baru ke modal
