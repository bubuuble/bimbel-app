// FILE BARU: app/dashboard/components/DashboardLayoutRenderer.tsx
...
export default function DashboardLayoutRenderer({
  ...
  // Tentukan apakah kita berada di rute editor soal.
  // Pola ini akan cocok dengan /dashboard/class/xxx/ujian/yyy/edit
  const isQuestionEditorPage = pathname.includes('/ujian/') && pathname.includes('/edit');

  // Jika ini adalah halaman editor, render layout minimalis.
  if (isQuestionEditorPage) {
    return (
      <LanguageProvider>
        {/* Layout ini tidak memiliki sidebar atau header dashboard. */}
  ...
  // Jika bukan, render layout dashboard lengkap.
  return (
    <LanguageProvider>
